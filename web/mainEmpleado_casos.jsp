<%-- 
    Document   : mainEmpleado_casos
    Created on : 04-26-2019, 02:38:26 AM
    Author     : josea
--%>
    ...
    <body>
        ...
        <nav class="navbar border">
            <ul class="nav justify-content-center">
                <li class="nav-item">
                    <a class="nav-link " href="mainEmpleado.jsp">Principal</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="mainEmpleado_casos.jsp">Casos</a>
                </li>
            </ul>
        </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-10 border">
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade active show" id="pills-aprobacion" role="tabpanel" aria-labelledby="">
                                        ...
                                        <table class="table table-responsive-lg border">
                                            ...
                                            <tbody>
                                                <sql:query var="caso1" dataSource="jdbc/mysql">
                                                    ...
                                                    where casos.estado = 3 and idRevisor = ?
                                                ...
                                                <c:forEach var="casos1" items="${caso1.rows}">
                                                    <tr>
                                                        ...
                                                        <td width="5%">
                                                            <a href="mainEmpleado_observacion.jsp?idCaso=${casos1.idCaso}" class="btn btn-primary  d-flex justify-content-center align-content-between">
                                        ...
                                        <table class="table table-responsive-lg border">
                                            ...
                                            <tbody>
                                                <sql:query var="caso1" dataSource="jdbc/mysql">
                                                    ...
                                                    inner join empleados on empleados.idEmpleado = casos.idProgramador 
                                                    inner join estadoscaso on estadoscaso.idEstado = casos.estado
                                                    where casos.estado = 5 and idRevisor = ?
                                                    <sql:param value="${loginEmpleado}"/>
                                                </sql:query>
                                        ...
                                        <table class="table table-responsive-lg border">
                                            ...
                                            <tbody>
                                                <sql:query var="caso1" dataSource="jdbc/mysql">
                                                    ...
                                                    inner join empleados on empleados.idEmpleado = casos.idProgramador 
                                                    inner join estadoscaso on estadoscaso.idEstado = casos.estado
                                                    where casos.estado = 6 and idRevisor = ?
                                                    <sql:param value="${loginEmpleado}"/>
                                                </sql:query>
