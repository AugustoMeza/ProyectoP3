<%-- 
    Document   : mainJefeArea_bitacoras.jsp
    Created on : 05-17-2019, 12:56:02 PM
    Author     : josea
--%>
...
<html>
    <head>
        ...
        <title>Main Jefe Area - Bitacoras</title>
    </head>
    <body>
            ...
            <div class="container-responsive">
                <div class="row col-lg-12">
                    ...
                    <div class="col-lg-6">
                        ...
                        <c:forEach var="empleadoCaso" items="${empleados.rows}">
                            <c:if test="${empleadoCaso.idRevisor eq loginEmpleado}">

                                <a href="mainJefeArea_asignarEmpleado.jsp?idCaso=${param.idCaso}" style="color:white" class="btn btn-warning">Asignar Empleado</a>
                            </c:if>
                            <c:if test="${empleadoCaso.idRevisor != loginEmpleado}">
                                <h5>Caso asignado a ${empleadoCaso.nombres} ${empleadoCaso.apellidos}</h5>
                                
                                <a href="mainJefeArea_asignarEmpleado.jsp?idCaso=${param.idCaso}" style="color:white" class="btn btn-warning">Asignar otro Empleado</a>
                            </c:if>
                            ...
                            <tbody>
                                <c:forEach var="observacion" items="${observaciones.rows}">
                                   <tr>
                                        ...
                                        <td width="5%">${observacion.idObservacion}</td>
                                    </tr> 
                                </c:forEach>
