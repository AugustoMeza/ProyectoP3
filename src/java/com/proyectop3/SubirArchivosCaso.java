 ...
 * @author josea
 */
public class SubirArchivosCaso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String caso = multi.getParameter("idCaso");
        ...
        out.println("<a href=mainJefeDesarrollo_casos.jsp class=\\\"btn btn-success\\\">Regresar</a>");
        //obtenemos el nombre del archivo
        String nombreArchivo = ficheroTemp.getName();
        Statement s = conexion.createStatement();
        s.executeUpdate("update casos set archivoPdf = "+ "\"" + nombreArchivo + "\"" + " where idCaso = " + "\"" + caso + "\"");
        }
